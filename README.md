# rCore-Tutorial-v3
rCore-Tutorial for arm64. See the [Main Documentation in Chinese](https://rcore-os.github.io/rCore-Tutorial-Book-v3/) and [Arch Releted Documentation](./doc/index.md).

## Overview

This project aims to show how to write an **Unix-like OS** running on **Arm64** platforms **from scratch** in **[Rust](https://www.rust-lang.org/)** for **beginners** without any background knowledge about **computer architectures, assembly languages or operating systems**.

## Features

* Platform supported: `qemu-system-aarch64` simulator.
* OS
